    ...
    <div class="row">
      <div class="col-md-3 offset-md-6">
        <div class="d-grid gap-2">
          <router-link type="button" class="btn btn-info" to="/listar-marca">Voltar
          </router-link>
        </div>
      </div>
      <div class="col-md-3 ">
...
export default defineComponent({
  ...
  methods: {
    ...
    onClickEditar() {
      MarcaClient.editar(this.marca.id, this.marca).then(success => {
        this.marca = new Marca()
    ...
    onClickExcluir() {
      MarcaClient.deletar(this.marca.id).then(success => {
        this.marca = new Marca()
