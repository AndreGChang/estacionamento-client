<template>
    <div class="container text-center">
        <div class="row d-flex align-items-center">
            <div class="col">
                <h1>Lista Condutor</h1>
            </div>
            <div class="col">
                <RouterLink to="/cadastrar-condutor">
                ...
                <table class="table table-dark table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th scoped="col">CPF</th>
                            <th scoped="col">Telefone</th>
                            <th scope="col">Opc</th>
                        </tr>
                    </thead>
                    <tbody>
                                    ...
                                    <div class="p-2 g-col-6">
                                        <div class="btn-group" role="group" ariel-label="Basic mixed styles example">
                                            <RouterLink type="button" class="btn btn-outline-warning"
                                                :to="{ name: 'cadastrar-condutor-editar-view', query: { id: item.id, form: 'editar' } }">
                                        ...
                                        <div class="btn-group" role="group" ariel-label="basic mixed styles example">
                                            <RouterLink type="button" class="btn btn-outline-danger"
                                                :to="{ name: 'cadastrar-condutor-excluir-view', query: { id: item.id, form: 'excluir' } }">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
